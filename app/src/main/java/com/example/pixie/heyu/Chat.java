...
import com.example.pixie.heyu.custom.CustomActivity;
import com.example.pixie.heyu.model.Conversation;
import com.example.pixie.heyu.utils.Const;
...
public class Chat extends CustomActivity {
    ...
    private class ChatAdapter extends BaseAdapter
    {
        ...
        public View getView(int pos, View v, ViewGroup arg2)
        {
            ...
            if (c.isSent())
                v = getLayoutInflater().inflate(R.layout.chat_snd_msg, null);
            else
                v = getLayoutInflater().inflate(R.layout.chat_rcv_msg, null);
